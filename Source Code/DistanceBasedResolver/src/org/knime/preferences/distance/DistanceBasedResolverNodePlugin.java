 ...
 */
public class DistanceBasedResolverNodePlugin extends Plugin {
    // The shared instance.
    private static DistanceBasedResolverNodePlugin plugin;

    /**
     * The constructor.
     */
    public DistanceBasedResolverNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DistanceBasedResolverNodePlugin getDefault() {
        return plugin;
    }
