 ...
 */
public class DominationMaximizerNodePlugin extends Plugin {
    // The shared instance.
    private static DominationMaximizerNodePlugin plugin;

    /**
     * The constructor.
     */
    public DominationMaximizerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static DominationMaximizerNodePlugin getDefault() {
        return plugin;
    }
