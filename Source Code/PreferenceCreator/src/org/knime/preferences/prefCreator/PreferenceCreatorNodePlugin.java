 ...
 */
public class PreferenceCreatorNodePlugin extends Plugin {
    // The shared instance.
    private static PreferenceCreatorNodePlugin plugin;

    /**
     * The constructor.
     */
    public PreferenceCreatorNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PreferenceCreatorNodePlugin getDefault() {
        return plugin;
    }
