 ...
 *
 */
package org.knime.preferences.extract;
 ...
 */
public class PreferenceSQLExtractNodePlugin extends Plugin {
    // The shared instance.
    private static PreferenceSQLExtractNodePlugin plugin;

    /**
     * The constructor.
     */
    public PreferenceSQLExtractNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PreferenceSQLExtractNodePlugin getDefault() {
        return plugin;
    }
