 ...
 */
public class BlockNestedLoopNodePlugin extends Plugin {
    // The shared instance.
    private static BlockNestedLoopNodePlugin plugin;

    /**
     * The constructor.
     */
    public BlockNestedLoopNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static BlockNestedLoopNodePlugin getDefault() {
        return plugin;
    }
