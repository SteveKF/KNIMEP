 ...
 */
public class RepresentativeSkylineNodePlugin extends Plugin {
    // The shared instance.
    private static RepresentativeSkylineNodePlugin plugin;

    /**
     * The constructor.
     */
    public RepresentativeSkylineNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static RepresentativeSkylineNodePlugin getDefault() {
        return plugin;
    }
