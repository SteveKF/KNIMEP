 ...
 */
public class SkylineVisualizerNodePlugin extends Plugin {
    // The shared instance.
    private static SkylineVisualizerNodePlugin plugin;

    /**
     * The constructor.
     */
    public SkylineVisualizerNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static SkylineVisualizerNodePlugin getDefault() {
        return plugin;
    }
