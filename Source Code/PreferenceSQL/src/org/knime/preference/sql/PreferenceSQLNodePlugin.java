 ...
 */
public class PreferenceSQLNodePlugin extends Plugin {
    // The shared instance.
    private static PreferenceSQLNodePlugin plugin;

    /**
     * The constructor.
     */
    public PreferenceSQLNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static PreferenceSQLNodePlugin getDefault() {
        return plugin;
    }
